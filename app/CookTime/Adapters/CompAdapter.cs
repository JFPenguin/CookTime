...
namespace CookTime.Adapters {
    /// <summary>
    /// This class is a custom adapter for the ListView containing a recipe's ingredient.
    ...
    public class CompAdapter : BaseAdapter<string> {
        ...
        /// <summary>
        /// Setter property for the _compItems attribute
        /// </summary>
        public IList<string> CompItems
        {
            set => _compItems = value;
        }
    }
}