...
namespace CookTime.Adapters {
    ...
    /// </summary>
    public class RecipeAdapter : BaseAdapter<string> {
        ...
        public RecipeAdapter(Context context, IList<string> items) {
            _context = context;
            _recipeItems = items;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent) {
            ...
            var recipeName = _recipeItems[position].Split(';')[1];
            var authorName = _recipeItems[position].Split(';')[2];

            recipeTxt.Text = recipeName + " by: " + authorName;
